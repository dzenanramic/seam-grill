...
export const metadata: Metadata = {
  title: "Kontakt",
  description:
    "Kontaktirajte restoran Pite pod sačem u Banja Luci za narudžbe, informacije i dostavu.",
  openGraph: {
    title: "Kontakt | Pite pod sačem Sač",
    description:
      "Kontaktirajte restoran Pite pod sačem u Banja Luci za narudžbe, informacije i dostavu.",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Kontakt restoran Pite pod sačem Sač Banja Luka",
      },
    ],
  },
  twitter: {
...
function SocialLink({ href, icon, label }: SocialLinkProps) {
  return (
    <a
      ...
      aria-label={label}
    >
      <div className="bg-[#FBBF24] p-3 rounded-full group-hover:bg-yellow-400 transition-colors duration-300">
        {icon}
      </div>
